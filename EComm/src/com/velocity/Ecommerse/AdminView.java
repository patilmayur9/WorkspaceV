...
{	 
	public void AdminHomeTab() throws SQLException
	{
		...
		System.out.println("1. Insert Product Details \t 2.Check Product Quantity \t 3.Registered User List \t 4. Check Perticular User History \t 5. Exit");
		System.out.println();
		System.out.println("Enter Your Choice : ");
		int ch=sc.nextInt();
		
		InsertProductDetails insertProductDetails=new InsertProductDetails(); // Created Object of Insert Poroduct Class
		...
		switch(ch)
		{
			case 1:
			{
				...
				insertProductDetails.insertProduct();  // By selecting Option one InsertProduct method will be called with Object Reference
				break;
			}
			case 2:
			{
				...
				checkproductquantity.getQuantity(); // By Selecting  This Option getQuanitity Method wil be called with Object Reference
			...
			{   System.out.println("========================");
				...
				System.out.println("========================");
				displayuserlist.getUserList();   // By Selecting This Option getUserList Method will be Called by Object Reference
				break;
			}
			case 4:
			{
				...
				userhistory.getUserList();    // By Selecting this Option getUserList method will be called from UserHistory Class.
				break;
			}
