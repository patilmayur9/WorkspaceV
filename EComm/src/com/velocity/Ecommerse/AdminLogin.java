...
public class AdminLogin extends Properties  {
	...
	public void aLogin() {
		...
		try { 
			...
			FileInputStream fis = new FileInputStream("E:\\velocity_eclips_workspace\\EComm\\admin.properties");
			...
			TablePassword = p.getProperty("password");  // Fetch  Password  from Properties and store into  password varaiable
